...
export interface CpinVirtualPanelInterface extends utils.Interface {
  functions: {
...
export interface CpinVirtualPanel extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CpinVirtualPanelInterface;
