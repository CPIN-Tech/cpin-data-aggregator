...
export interface LinearReleaseTokenInterface extends utils.Interface {
  functions: {
...
export interface LinearReleaseToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LinearReleaseTokenInterface;
