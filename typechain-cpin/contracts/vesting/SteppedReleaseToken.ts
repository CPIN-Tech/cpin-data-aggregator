...
export interface SteppedReleaseTokenInterface extends utils.Interface {
  functions: {
...
export interface SteppedReleaseToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SteppedReleaseTokenInterface;
